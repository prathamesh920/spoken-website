...
#    ),
    ...
    url(
      ...
      viewsv2.ReOpenTraining, 
      name="re-open-training"
    ),
    url(
      r'^payment-home/$', 
      viewsv2.payment_home, 
      name="payment_home"
    ),
      url(
      r'^payment-status/$', 
      viewsv2.payment_status, 
      name="payment_status"
    ),
      url(
      r'^payment-success/$', 
      viewsv2.payment_success, 
      name="payment_success"
    ),
    url(
      r'^payment-details/(?P<choice>\w+)/$', 
      viewsv2.payment_details, 
      name="payment_details"
    ),
    url(
      r'^payment-reconciliation-update/$', 
      viewsv2.payment_reconciliation_update, 
      name="payment_reconciliation_update"
    ),
    
    url(r'^academic-transactions/$', viewsv2.academic_transactions,name="payment"),
